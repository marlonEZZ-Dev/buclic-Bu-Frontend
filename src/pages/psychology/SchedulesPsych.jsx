        ...
        <tbody>
          {scheduleData.map((schedule, dateIndex) => (
            <React.Fragment key={`fragment-${dateIndex}`}>
              ...
              {/* Fila para las horas adicionales */}
              {schedule.times.slice(1).map((time, timeIndex) => (
                <tr key={`time-${dateIndex}-${timeIndex + 1}`}>
                  <td key={`emptyTime-${dateIndex}-${timeIndex + 1}`}></td>
                  <td key={`cellTime-${dateIndex}-${timeIndex + 1}`}>
                    <TimeSpanish
                      key={`timeSpanish-${dateIndex}-${timeIndex + 1}`}
                      value={time}
              ...
              <tr key={`RowLink-${dateIndex}`}>
                <td key={`emptyTime-${dateIndex}-link`}></td>
                <td key={`cellTime-${dateIndex}-link`}>
                  <Button
